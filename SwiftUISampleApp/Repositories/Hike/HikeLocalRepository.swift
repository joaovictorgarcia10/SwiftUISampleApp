//
//  HikeLocalRepository.swift
//  SwiftUISampleApp
//
//  Created by João Victor Garcia Leite Santana on 28/01/25.
//

import Foundation

enum HikeLocalRepositoryError : Error {
    case fileNotFound(String)
    case impossibleLoadFile(String)
    case impossibleParseFile(String)
}

class HikeLocalRepository : BaseRespository {
